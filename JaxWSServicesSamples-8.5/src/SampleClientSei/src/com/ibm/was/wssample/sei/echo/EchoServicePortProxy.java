...
public class EchoServicePortProxy{
    ...
    public class Descriptor {
        private EchoService _service = null;
        private com.ibm.was.wssample.sei.echo.EchoServicePortTypeClient _proxy = null;
        ...
        public Descriptor(URL wsdlLocation, QName serviceName) {
            _service = new EchoService(wsdlLocation, serviceName);
            initCommon();
        }
        ...
        public com.ibm.was.wssample.sei.echo.EchoServicePortTypeClient getProxy() {
            return _proxy;
        }
