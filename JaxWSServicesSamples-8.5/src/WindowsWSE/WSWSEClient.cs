...
public partial class WSWSEClient
{
  ...
  {
    WSWSEClient ws = new WSWSEClient();
  ...
  void PrintUsage()
  {
    ...
    Console.WriteLine("  WSWSEClient -h [hostname] -p [port] -f [urlSuffix] -m [testMessage] -s [echo|ping|async] -t [asynctimeout]");
  ...
  static void EchoCallback(IAsyncResult ar)
  {
    ...
    EchoService echosv = (EchoService)ar.AsyncState;
