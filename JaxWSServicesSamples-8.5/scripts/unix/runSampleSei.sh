...
CLASSPATH=$THIN_JAR:$SAMPLES_HOME/installableApps/WSSampleClientSei.jar
"$JAVA_HOME/bin/java" $JAVA_LIB_PATH $ENDORSED -cp "$CLASSPATH" com.ibm.was.wssample.sei.cli.SampleClient "$@"
exit 0
