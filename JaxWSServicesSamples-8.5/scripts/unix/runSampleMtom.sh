...
CLASSPATH=$THIN_JAR:$SAMPLES_HOME/installableApps/WSSampleMTOMClient.jar
"$JAVA_HOME/bin/java" $JAVA_LIB_PATH $ENDORSED -cp "$CLASSPATH" org.apache.axis2.jaxws.sample.mtom.SampleMTOMTests "$@"
exit 0
